...
class Select2 extends Component {
    static defaultProps = {
        cancelButtonText: _.t('cancelButtonText'),
        selectButtonText: _.t('selectButtonText'),
        searchPlaceHolderText: _.t('searchPlaceHolderText'),
        listEmptyTitle: _.t('listEmptyTitle'),
        colorTheme: '#FF5E89',
        buttonTextStyle: {},
        buttonStyle: {},
        showSearchBox: true
