...
class MessageDetail extends Component {
  ...
  render() {
    const {loading, dialog, dialog_messages} = this.props.user;
                ...
                <RefreshControl
                  ...
                  onRefresh={() => {
                    this.props.dialogRequest({
                      id: this.props.route.params.dialog_id,
                    });
                  }}
                />
              }
                  ...
                  <View
                    ...
                    <View style={{flexDirection: 'row'}}>
                      <Text
                        style={
                          item.my
                            ? styles.yourMessageName
                            : styles.userMessageName
                        }>
                    ...
                    <View
                      style={item.my ? styles.yourMessage : styles.userMessage}>
                      {item.image === null ? (
                        <Text
                          style={
                            item.my
                              ? styles.yourMessageTxt
                              : styles.userMessageTxt
                          }>
                          {item.message}
                        </Text>
                      ) : (
            ...
            <View style={styles.boxMessageInput}>
              ...
              <View
                ...
                <TextInput
                  ...
                  style={[
                    styles.input,
                    {inputHeight: Math.max(35, inputHeight)},
                  ]}
                  value={message}
                  multiline={true}
...
export default connect(mapStateToProps, {dialogRequest, messageSendRequest})(
  MessageDetail,
);
