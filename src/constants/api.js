...
const ENDPOINT_SERVICE_ADD = BACKEND_URL_PREFIX + '/procedures/store';
const ENDPOINT_SERVICE_UPDATE = BACKEND_URL_PREFIX + '/procedures/update';
const ENDPOINT_SERVICE_DETAILS = BACKEND_URL_PREFIX + '/procedures/edit';
const ENDPOINT_SERVICE_DRAFT = BACKEND_URL_PREFIX + '/procedures/draft';
const ENDPOINT_SERVICE_DELETE = BACKEND_URL_PREFIX + '/procedures/delete';
const ENDPOINT_PROMOS = BACKEND_URL_PREFIX + '/promos';
const ENDPOINT_PROMOS_CATS = BACKEND_URL_PREFIX + '/promos/cats';
const ENDPOINT_PROMO_ADD = BACKEND_URL_PREFIX + '/promos/store';
const ENDPOINT_PROMO_UPDATE = BACKEND_URL_PREFIX + '/promos/update';
const ENDPOINT_PROMO_DETAILS = BACKEND_URL_PREFIX + '/promos/edit';
const ENDPOINT_PROMOS_DRAFT = BACKEND_URL_PREFIX + '/promos/draft';
const ENDPOINT_PROMOS_DELETE = BACKEND_URL_PREFIX + '/promos/delete';
