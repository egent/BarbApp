                ...
                <>
                  ...
                  {showDatepicker && (
                    <>
                      ...
                      {Platform.OS === 'ios' && (
                        <TouchableOpacity
                          style={[globalStyle.center, styles.saveTextBtn]}
                          onPress={() => {
                            const date = moment(birthdayRaw).format(
                              'DD.MM.YYYY',
                            );
                            this.setState({
                              showDatepicker: false,
                ...
                <View style={{flexDirection: 'row'}}>
                  ...
                  <Text
                    style={[
                      ...
                      {
                        color:
                          email_verified && showTick !== true
                            ? 'green'
                            : '#FF5E89',
                      },
                    ]}>
                    {_.t(
                      email_verified === true && showTick !== true
                        ? 'confirmed'
                        : 'unconfirmed',
                    )}
                  </Text>
                  ...
                  <View
                    ...
                    <TextInput
                      ...
                      onChangeText={(val) => {
                        this.setState({
                          email: val,
                          showTick: this.emailValidate(val) ? true : false,
                        });
                      }}
                      value={email}
                      // blurOnSubmit={()=>Keyboard.dismiss()}
